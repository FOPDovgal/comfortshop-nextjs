          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`desktop-cat-btn flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-medium uppercase tracking-wider whitespace-nowrap transition-all duration-200 ${
                  isActive
