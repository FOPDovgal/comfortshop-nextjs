...
import { getAllTops, getTopBySlugFull, getAllArticlesForCategory } from "@/lib/mdx";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://comfortshop.com.ua/top/${slug}` },
    openGraph: {
      type: "article",
      title,
      description,
      url: `https://comfortshop.com.ua/top/${slug}`,
      images,
...
export default async function TopPage({ params }: Props) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Топ-списки", item: "https://comfortshop.com.ua/top" },
      { "@type": "ListItem", position: 3, name: frontmatter.title, item: `https://comfortshop.com.ua/top/${slug}` },
    ],
  };
